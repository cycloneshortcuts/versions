...
- Projects Update: each project has its own folder containing a Globals.json file. Dont worry, old Cyclone shortcuts using Global Variables will still be compatible. There is a guide in the new (https://routinehub.co/shortcut/20534/) for this
